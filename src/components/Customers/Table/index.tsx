    ...
    <table className='mx-auto w-full whitespace-nowrap rounded-lg bg-white divide-y divide-slate-200 overflow-hidden'>
      <thead className="bg-blue-dark">
        <tr className="text-white text-left">
          ...
          <th className="font-semibold text-sm uppercase px-6 py-4"> Insured First Name </th>
          <th className="font-semibold text-sm uppercase px-6 py-4"> Insured Last Name </th>
