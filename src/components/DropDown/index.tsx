	...
	return (
		<Listbox as="div" className="relative" value={value} onChange={onChange}>
			<div className="flex flex-col py-2 rounded-sm space-y-2">
				...
				<Listbox.Button className="text-sm flex justify-between items-center w-64 placeholder-slate-400 bg-neutral-100 font-normal rounded-md outline-none pl-6 pr-6 py-3">
					{value.display}
